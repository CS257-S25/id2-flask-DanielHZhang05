...
class TestCovidStats(unittest.TestCase):
    ...
    def test_main(self):
       ...
       self.assertEqual(app.aboutpage, "To access Go to the url http://127.0.0.1:5000/covid_stats/Afghanistan/2021-01-01/2022-01-12 to get the total cases and deaths in Afghanistan between 2021-01-01 to 2022-01-12")
